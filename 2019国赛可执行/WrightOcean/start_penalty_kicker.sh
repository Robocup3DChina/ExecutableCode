#!/bin/bash
#
# WrightOcean start penalty kicker script for 3D Simulation Competitions
#
...
"$BINARY_DIR/$AGENT_BINARY" $opt --unum 2 --type 1 --paramsfile paramfiles/defaultParams_t4.txt --pkshooter &#> /dev/null &
