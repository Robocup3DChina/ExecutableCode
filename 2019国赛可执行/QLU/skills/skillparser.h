...
//                     << '=' << effValues[i] << endl;
                    // translate str->enum-index
                    effIndices.push_back( EnumParser<Effectors>::getEnumFromString( effectors[i] ) );
		    //4.10 关节名 cout<<"----"<<effectors[i]<<"----"<<endl;
                }
		//4.10 cout<<"----"<<effIndices<<"----"<<effValues<<endl;
...
//          EnumParser<BodyParts> enumParser;
		...
		//4.10 cout<<"currentSkillType:"<<currentSkillType<<"----"<<parser.skills[currentSkillType]<<endl;
		//currentSkillType = 1\2\4
		//SkillType名 cout<<"----"<<skillname<<"----"<<endl;
            }
