...
for ((i=1;i<=$NUM_PLAYERS;i++)); do
	...
	1|2)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 0 --paramsfile paramfiles/defaultParams_t4.txt &#> /dev/null &
	...
	5|6)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 2 --paramsfile paramfiles/defaultParams_t1.txt &#> /dev/null &
